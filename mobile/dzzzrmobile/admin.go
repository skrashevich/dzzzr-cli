...
func (c *DzzzrClient) AdminListGames() (string, error) {
...
func (c *DzzzrClient) AdminListLevels(gameID int64) (string, error) {
...
func (c *DzzzrClient) AdminListTeams(gameID int64) (string, error) {
...
func (c *DzzzrClient) AdminMonitor(gameID int64) (string, error) {
...
func (c *DzzzrClient) AdminGetLog(gameID int64, since string) (string, error) {
...
func (c *DzzzrClient) AdminListMessages(gameID, teamID int64) (string, error) {
...
func (c *DzzzrClient) AdminSendMessage(gameID, teamID int64, text, showAfter string, important bool) error {
...
// "YYYY-MM-DD HH:MM:SS".
func (c *DzzzrClient) AdminGiveLevel(gameID, teamID, level int64, at string) error {
...
func (c *DzzzrClient) AdminAcceptCode(gameID, teamID, level int64, code, at string) error {
...
func (c *DzzzrClient) AdminAddCorrection(gameID, teamID int64, kind string, minutes int64, comment string) error {
...
func (c *DzzzrClient) AdminSetTeamBlocked(gameID, teamID int64, blocked bool) error {
	if blocked {
...
func (c *DzzzrClient) AdminSetEngine(gameID int64, running bool) error {
